...
main = do
    spawn "killall trayer ; trayer --edge top --align right --SetDockType true --SetPartialStrut false --expand true --width 10 --widthtype percent --transparent false --tint 0x000000 --height 20" -- gnome-sound-appletのアイコンが黒一色でない場合は--transparent trueにすると統一感があっていいです。
--    spawn "gnome-power-manager"
    spawn "killall nm-applet ; nm-applet"
    spawn "gnome-sound-applet" -- gnome-volume-control-applet?
    spawn "nautilus --no-default-window --no-desktop"
    spawn "dropbox start"
